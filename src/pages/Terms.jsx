        ...
        <>
            ...
            <div className="h-[90vh] min-h-fit w-full flex justify-center items-start">
                <div className="flex flex-col justify-between text-justify  sm:text-left mx-4 sm:mx-6 md:mx-15 py-4 gap-10 my-15">
                    ...
                    <p>Kinra & Associates makes reasonable efforts to ensure the accuracy of information shared on this site. However, we disclaim liability for any loss, damage, or inconvenience arising from reliance on the content. Users should seek direct consultation with a qualified professional before making any decisions.</p>


                    <p>All materials, including text and downloadable content, are the intellectual property of Kinra & Associates. Unauthorized copying, distribution, or reproduction is prohibited. Links to external websites are provided for convenience; we do not control or endorse their content.</p>
                    ...
                    <div className="flex flex-col w-full gap-7">
                        ...
                        <p className="w-full text-justify">
                            All information presented here is intended to provide general guidance on accounting, taxation, and regulatory matters. While care is taken to ensure accuracy, Kinra & Associates makes no warranties regarding completeness or reliability and disclaims any liability for loss or damage arising from reliance on this information.
                        </p>
                        <p className="w-full text-justify">

                            This website may contain links to external sites provided for user convenience. Kinra & Associates does not endorse or control such sites and is not responsible for their content, accuracy, or availability. Users should verify all information independently before reliance.


                        </p>
                        <p className="w-full text-justify">By continuing to use this website, you agree to comply with all applicable laws and these Terms and Conditions. Kinra & Associates reserves the right to update or modify these terms at any time without prior notice. Continued use implies acceptance of any such changes.</p>
